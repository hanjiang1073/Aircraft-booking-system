...
<body>
	<div class="abs_container clearfix b_container">
		...
		<form action="${basePath}Booking?method=order" method="post" class="b_form">
			...
			<div class="b_form_mainPassenger">
				...
				<div class="bf_passenger_info clearfix">
					<div class="bfp_info_text">
						...
						<span>联系人ID：</span>
							<div>
								<input type="" name="UserID" oInfocus="textOnFocus(this)" onblur="textOnBlur(this)">
							</div>
						</div>
					</div>
				</div>
			...
			<div>
			  <c:forEach items="${flightInfoList}" var="flightInfo">
			    ...
			    <input type="text" name="fno" value="${flightInfo.fno}">
			    <input type="text" name="price" value="${flightInfo.price}">
				...
				<c:forEach items="${flightInfoList}" var="flightInfo">
					<div class="bo_info_item">
						<div class="bo_info_flightArea">
							...
							<span class="bo_info_city">${flightInfo.departapname}</span>
							<img class="bo_info_arrow" src="images/info_arrow_icon.png">
							<span class="bo_info_city">${flightInfo.arriveapname}</span>
						</div>
						<div class="bo_info_airlineArea">
							<span class="bo_info_airline">${flightInfo.airlineName} ${flightInfo.fno}${flightInfo.number}</span>
						...
						<div class="bo_detail_subtotal clearfix">
							...
							<span class="bo_detail_value">￥
								<span class="bo_detail_fare">
									<fmt:formatNumber type="number" groupingUsed="false" value="${flightInfo.price}" />
									<c:set var="totalFare" value="${totalFare + flightInfo.price}"/>
								</span> 
								 &times;
